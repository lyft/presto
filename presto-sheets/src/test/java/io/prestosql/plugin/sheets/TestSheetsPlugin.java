...
import static io.prestosql.plugin.sheets.SheetsSimpleIntegrationTest.SHEETS;
...
public class TestSheetsPlugin
{
    ...
    {
        return Paths.get(ClassLoader.getSystemResource("gsheets-credentials.json").toURI()).toString();
    }
