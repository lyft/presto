        ...
        implements Rule<ProjectNode>
{
    ...
    /*
    See PushProjectionIntoTableScan. Try generating new ConnectionExpressions with
    a pruned type and pass into applyProjection to generate new ProjectionApplicationResult.
    Change applyProjection for Hive to:
    - Look for Variable types in List<ConnectorExpression>
    - Check if type of Variable is different than type
      of same named assignment and if so, replace the type
      of the ColumnHandle.
    Follow similar logic in PushProjectionIntoTableScan to generate new
    table scan.
     */
    @Override
